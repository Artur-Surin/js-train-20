...
this.showInfo = function () {
  console.log(`
    ...
    Колір: ${this.color}
    Тип двигуна: ${this.engineType}
    Вантажопідйомність: ${this.towingCapacity} кг
    Тип пального: ${this.fuelType}
    Тип трансмісії: ${this.transmissionType}
    Кількість дверей: ${this.doors}
    Вага: ${this.weight} кг
  `);
};
}
...
const driveMyTruck = myTruck.drive.bind(myTruck);
